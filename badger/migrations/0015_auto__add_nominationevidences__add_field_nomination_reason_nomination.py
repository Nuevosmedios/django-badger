...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NominationEvidences'
        db.create_table(u'badger_nominationevidences', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nomination', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['badger.Nomination'])),
            ('file_evidence', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'badger', ['NominationEvidences'])

        # Adding field 'Nomination.reason_nomination'
        db.add_column(u'badger_nomination', 'reason_nomination',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'NominationEvidences'
        db.delete_table(u'badger_nominationevidences')

        # Deleting field 'Nomination.reason_nomination'
        db.delete_column(u'badger_nomination', 'reason_nomination')
    ...
    models = {
        ...
        u'badger.award': {
            ...
            'show_badge': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'badger.deferredaward': {
            ...
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['badger.Badge']"}),
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'e3mejy'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        u'badger.nomination': {
            ...
            'reason_nomination': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'badger.nominationevidences': {
            'Meta': {'object_name': 'NominationEvidences'},
            'file_evidence': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nomination': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['badger.Nomination']"})
        },
        u'badger.progress': {
