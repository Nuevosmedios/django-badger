...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Badge.badgeType'
        db.add_column(u'badger_badge', 'badgeType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Badge.badgeType'
        db.delete_column(u'badger_badge', 'badgeType')
    ...
    models = {
        ...
        u'badger.deferredaward': {
            ...
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['badger.Badge']"}),
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'yhwtf9'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
