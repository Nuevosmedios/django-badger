    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(storage=django.core.files.storage.FileSystemStorage(), max_length=256, null=True, upload_to=badger.models.UploadTo(b'image', b'png'), blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text=b'Upload an image to represent the badge', max_length=256, null=True, upload_to=badger.models.UploadTo(b'image', b'png'), blank=True)),
                ...
                ('badgeType', models.CharField(default=b'', max_length=3, null=True, blank=True, choices=[(b'AS', 'Assignment'), (b'APP', 'Application'), (b'AT', 'Automatic')])),
