...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Award.image'
        db.alter_column(u'badger_award', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))

        # Changing field 'Badge.image'
        db.alter_column(u'badger_badge', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Award.image'
        db.alter_column(u'badger_award', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Badge.image'
        db.alter_column(u'badger_badge', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'badger.deferredaward': {
            ...
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['badger.Badge']"}),
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'7ch7vk'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
