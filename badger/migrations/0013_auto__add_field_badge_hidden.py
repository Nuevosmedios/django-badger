...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Badge.hidden'
        db.add_column(u'badger_badge', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Badge.hidden'
        db.delete_column(u'badger_badge', 'hidden')
    ...
    models = {
        ...
        u'badger.deferredaward': {
            ...
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['badger.Badge']"}),
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'7j9jnf'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
