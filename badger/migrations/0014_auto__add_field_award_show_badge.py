...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Award.show_badge'
        db.add_column(u'badger_award', 'show_badge',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Award.show_badge'
        db.delete_column(u'badger_award', 'show_badge')
    ...
    models = {
        ...
        u'badger.deferredaward': {
            ...
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['badger.Badge']"}),
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'fhw74x'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
